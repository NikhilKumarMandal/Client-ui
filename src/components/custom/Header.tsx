      ...
      <nav className="container py-5 flex flex-wrap items-center justify-between md:justify-around">
        ...
        <div className='flex items-center gap-3 mt-3 md:mt-0'>
          ...
          <div className='relative'>
            ...
            <span className='absolute -top-2 -right-2 h-6 w-6 flex items-center justify-center rounded-full bg-primary font-bold text-white'>3</span>
          </div>
          <div className='flex items-center ml-3'>
            <Phone />
            <span> +91 6204959935</span>
          </div>
          <Button size={'sm'}>
            Logout
          </Button>
